...
public class spark{
    public static void main(String[] args) throws IOException {
        try {
            ...
            JavaRDD<String> lines = sparkContext.textFile("hdfs://master:9000/user/temp/4300-0.txt", 2).toJavaRDD();
            ...
            wordCount.repartition(1).saveAsTextFile("hdfs://master:9000/user/temp/output.txt" );/* args[0]*/
